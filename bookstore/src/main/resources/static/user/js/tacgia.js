...
window.onload = function () {
    var fileInputs = document.querySelectorAll('[id^="editlinkAnhTacGia-"]');

    fileInputs.forEach(function (fileInput) {
        var tacGiaId = fileInput.id.replace('editlinkAnhTacGia-', '');
        var imageElement = document.getElementById('editviewLinkAnhTacGia-' + tacGiaId);
        var deleteButton = document.getElementById('deleteButton1-' + tacGiaId);
